...
//error_reporting(0);
require('koneksi.php');
require('tampil_edit_status.php');
...
<form method="post" action="">
	<table>
	<tr>
		<td colspan='3' align='center'>Tampilkan Data Alat</td>
	</tr>
	<tr>
		<td>Kategori Alat</td>
		<td>:</td>
...
<?php
	if ($kategori!="" && $jenis!="" )
		...
		echo '<FORM ACTION="?p=40" METHOD="POST" NAME="input">
		<table width="60%" border="1">
		<tr><td colspan="3" alight="center"><b>Pencarian data alat</b></td></tr>
		<tr><td width="20%">kode alat</td>
			<td width="2%">:</td>
			<td width="38%"><input name="kode" size="9" maklength="9">
			</td>
		</tr>
		<tr><td colspan="2"></td>
